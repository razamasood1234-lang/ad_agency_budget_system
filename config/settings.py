...
SECRET_KEY = 'django-insecure-7hd$!cukn#a&g9a3=@$&a-z7kz2drrucsc3mr1!0@f3u(ces*@'
...
TIME_ZONE = 'Asia/Karachi'  # Pakistan time (UTC+5)

# Use timezone-aware datetimes
USE_TZ = True

# Optional: Set default timezone for Celery too
